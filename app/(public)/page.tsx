      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <h3 className="mb-4 text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
              <div className="flex gap-4 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">دامنه اختصاصی</h4>
              ...
              <div className="flex gap-4 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">آمار پیشرفته</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              <div className="flex gap-4 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">رمزگذاری لینک</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              <div className="flex gap-4 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">انقضای خودکار</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              <div className="flex gap-4 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">QR Code</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              <div className="flex gap-4 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">API کامل</h4>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <Card className="bg-gradient-to-r from-teal-500 via-cyan-600 to-teal-500 border-0 text-white overflow-hidden relative">
            ...
            <CardContent className="pt-12 pb-12 relative z-10">
              <div className="text-center space-y-6 max-w-3xl mx-auto">
                <h3 className="text-4xl md:text-5xl font-bold">آماده شروع هستید؟</h3>
